...
{
	TyphoonGameState::TyphoonGameState( const Ogre::String &helpDescription ) :
		mGraphicsSystem( 0 ),
		mCameraController( 0 ),
	...
	//-----------------------------------------------------------------------------------
	TyphoonGameState::~TyphoonGameState()
	{
		delete mCameraController;
		mCameraController = 0;
	}
	//-----------------------------------------------------------------------------------
	void TyphoonGameState::_notifyGraphicsSystem( GraphicsSystem *graphicsSystem )
	{
		mGraphicsSystem = graphicsSystem;
	}
	//-----------------------------------------------------------------------------------
	void TyphoonGameState::createScene01( void )
	{
		createDebugTextOverlay();
	}
	//-----------------------------------------------------------------------------------
	void TyphoonGameState::createDebugTextOverlay( void )
	{
	...
	//-----------------------------------------------------------------------------------
	void TyphoonGameState::generateDebugText( float timeSinceLast, Ogre::String &outText )
	{
	...
	//-----------------------------------------------------------------------------------
	void TyphoonGameState::update( float timeSinceLast )
	{
		if ( mDisplayHelpMode != 0 )
		{
			//Show FPS
	...
	//-----------------------------------------------------------------------------------
	void TyphoonGameState::keyPressed( const SDL_KeyboardEvent &arg )
	{
	...
	//-----------------------------------------------------------------------------------
	void TyphoonGameState::keyReleased( const SDL_KeyboardEvent &arg )
	{
	...
	//-----------------------------------------------------------------------------------
	void TyphoonGameState::mouseMoved( const SDL_Event &arg )
	{
		if ( mCameraController )
